...
//        isbnField.setEnabled(false);
        ...
        publishingYearField.setEnabled(false);
        rightPanel.add(publishingYearField);
        
        /***************************************************************************************************/
        bookQuantity = new JLabel("NEW QUANTITY: ");
        bookQuantity.setBounds(215, 345, 150, 20);
        ...
        /***************************************************************************************************/
        bookPrice = new JLabel("NEW PRICE: ");
        bookPrice.setBounds(215, 410, 150, 20);
...
//    JButton exit;
        ...
        if(ae.getSource() == saveButton ){
            dbm.updateBook(Integer.parseInt(isbnField.getText()), 
