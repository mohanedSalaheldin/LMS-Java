...
public class Start implements ActionListener{
    ...
    */ 
    ...
    public void rightPanelCustomization(){
        ...
        ImageIcon background=new ImageIcon("C:\\Users\\MoSala7\\Documents\\NetBeansProjects"
                + "\\Oop_Book_Store\\src\\oop_book_store\\L_Logo.png");
        Image img=background.getImage();
        Image temp=img.getScaledInstance(680,600,Image.SCALE_SMOOTH);
        background=new ImageIcon(temp);
        JLabel back=new JLabel(background);
        back.setLayout(null);
        back.setBounds(0,0,680,600);
